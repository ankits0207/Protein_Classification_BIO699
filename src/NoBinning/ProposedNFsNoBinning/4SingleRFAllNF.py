...
cvCount = 10
iterations = 4
clf = RandomForestClassifier(random_state=42, max_depth=41, max_features='sqrt', min_samples_leaf=2,
                             min_samples_split=5, n_estimators=56, bootstrap=False)
...
m = 508
t = 575
kf = StratifiedKFold(n_splits=cvCount)
