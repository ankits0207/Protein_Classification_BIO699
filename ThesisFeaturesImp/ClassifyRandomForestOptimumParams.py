...
featListToBeDropped = ['clco_0', 'clco_1', 'clco_2', 'clco_3', 'clco_4', 'clco_5', 'clco_6', 'clco_7', 'clco_8',
                       'clco_9', 'MD']

Df = mergedDf.copy()
Df.drop(featListToBeDropped, axis=1, inplace=True)
...
for threshold in thresholdRange:
    ...
    print('Result = p:' + str(overallPrecision / iterations) +
